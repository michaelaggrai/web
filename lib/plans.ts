...
export const PLANS: Plan[] = [
  {
    ...
    tagline: "10+ fast models, up to 3 per comparison",
    features: [
      "10+ fast models",
  ...
  },
  {
    ...
    tagline: "Every flagship model, up to 3 per comparison",
    features: [
      "Every flagship model",
      "Up to 3 models per comparison",
      "Sonnet 5, Kimi K3, Opus 5 Fast, GPT-4o, GPT-5.6 Sol, Gemini Pro, Grok 4.5…",
      "Everything in Free",
    ],
    icon: Zap,
  ...
  },
  {
    ...
    tagline: "Deep-research reasoning specialists, up to 5 per comparison",
    features: [
      "Deep-research reasoning specialists",
      "Up to 5 models per comparison",
      "Claude Opus 5, Claude Fable 5, GPT-5.6 Sol Pro, Qwen3 Max Thinking…",
      "Everything in Pro",
    ],
    icon: Crown,
