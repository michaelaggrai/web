...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    tagline: "4 research models",
    detail: "Everything in Pro plus 4 reasoning specialists — GPT-5.5 Pro, DeepSeek v4 Pro, Qwen3 Max Thinking, Grok 4.20 Multi-Agent. For deep research. Up to 5 models per comparison.",
  },
];
