...
const PLAN_OPTIONS: PlanOption[] = [
  ...
  { key: "pro",     name: "Pro",     price: "£11", period: "/mo",     tagline: "Every flagship: Opus 4.7, GPT-4o, Sonnet, Gemini Pro, Grok 4.20… up to 3 per comparison",  icon: Zap,      iconColor: "text-teal-300" },
  { key: "premium", name: "Premium", price: "£19", period: "/mo",     tagline: "+ 5 reasoning specialists (GPT-5.5 Pro, Qwen Max Thinking, DeepSeek v4 Pro…), up to 5 per comparison", icon: Crown, iconColor: "text-amber-300" },
];
