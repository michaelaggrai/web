    ...
    >
      <article className="prose prose-invert prose-sm sm:prose-base max-w-none
        ...
        <ul>
          ...
          <li><strong>Pro</strong> — 17 advanced models. Every flagship: Claude Opus 4.7 + Opus 4.7 Fast, Sonnet 4.6, GPT-4o, GPT-5.4/5.5, Gemini 2.5/3.x Pro, Grok 4.20, Llama 3.3 70B, Codex variants, Devstral, Qwen3 Coder. Up to 3 per comparison.</li>
