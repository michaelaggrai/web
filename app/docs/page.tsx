    ...
    >
      <article className="prose prose-invert prose-sm sm:prose-base max-w-none
        ...
        <ul>
          ...
          <li><strong>Premium</strong> — adds the deep-research models (Claude Opus 4.8, GPT-5.5 Pro, DeepSeek v4 Pro, Kimi K2 Thinking, GLM-5.1, MiniMax M2.5, Qwen3 Max Thinking, Grok 4.20 Multi-Agent). Up to 5 per comparison.</li>
        </ul>
        <p>
