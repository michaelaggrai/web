  ...
  },
  {
    ...
    a: (
      <>
        ...
        Sonnet 5, Haiku 4.5…), OpenAI (GPT-5.5 Pro, GPT-4o, GPT-4o Mini,
  ...
  },
  {
    ...
    a: (
      <>
        ...
        <br />
        <strong>Pro</strong> — 17 advanced models. Every flagship: Claude Sonnet 5, Opus 4.8 Fast, GPT-4o, GPT-5.5, Gemini Pro, Grok 4.5, Kimi K3, Llama 3.3 70B, Codex, Devstral, Nemotron 3 Super and more. Up to 3 per comparison.
        <br />
        <strong>Premium</strong> — 9 research models. For deep research: Claude Opus 4.8, GPT-5.5 Pro, DeepSeek v4 Pro, Kimi K2 Thinking, GLM-5.2, MiniMax M2.5, Qwen3 Max Thinking, Grok 4.20 Multi-Agent, Nemotron 3 Ultra. Up to 5 per comparison.
        <br />
