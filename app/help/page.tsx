  ...
  },
  {
    ...
    a: (
      <>
        ...
        <br />
        <strong>Pro</strong> — every flagship model: Claude Sonnet 5, Opus 5 Fast, GPT-4o, GPT-5.6, Gemini Pro, Grok 4.5, Kimi K3, Step 3.7 Flash, MiniMax M3, Llama 3.3 70B, Codex, Devstral, Nemotron 3 Super and more. Up to 3 per comparison.
        <br />
        <strong>Premium</strong> — reasoning specialists for deep research: Claude Opus 5, Claude Fable 5, GPT-5.6 Pro, DeepSeek v4 Pro, Kimi K2 Thinking, GLM-5.2, MiniMax M2.5, Qwen3 Max Thinking, Grok 4.20 Multi-Agent, Nemotron 3 Ultra. Up to 5 per comparison.
        <br />
