...
const FAQ: { q: string; a: React.ReactNode }[] = [
  ...
  },
  {
    ...
    a: (
      <>
        40+ models across 15 providers: Anthropic (Opus 4.8,
        Sonnet 5, Haiku 4.5…), OpenAI (GPT-5.6 Pro, GPT-4o, GPT-4o Mini,
  ...
  },
  {
    ...
    a: "No. Anyone can use the Free tier (10+ fast models, 3 per comparison) without an account. You only need an account to upgrade — Pro unlocks every flagship model (Opus 4.8 Fast, GPT-4o, Sonnet 5, Grok 4.5, Kimi K3, Gemini Pro…), Premium adds deep-research reasoning specialists and lets you compare up to 5 at once.",
  },
  {
    ...
    a: (
      <>
        ...
        <br />
        <strong>Pro</strong> — every flagship model: Claude Sonnet 5, Opus 4.8 Fast, GPT-4o, GPT-5.6, Gemini Pro, Grok 4.5, Kimi K3, Step 3.7 Flash, MiniMax M3, Llama 3.3 70B, Codex, Devstral, Nemotron 3 Super and more. Up to 3 per comparison.
        <br />
        <strong>Premium</strong> — reasoning specialists for deep research: Claude Opus 4.8, Claude Fable 5, GPT-5.6 Pro, DeepSeek v4 Pro, Kimi K2 Thinking, GLM-5.2, MiniMax M2.5, Qwen3 Max Thinking, Grok 4.20 Multi-Agent, Nemotron 3 Ultra. Up to 5 per comparison.
        <br />
