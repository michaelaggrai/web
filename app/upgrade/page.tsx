...
const PLANS = [
  ...
  },
  {
    ...
    description: "Every flagship model — Opus 4.7, GPT-4o, Sonnet 4.6, Grok and more.",
    features: [
      "Everything in Free, plus…",
      "Claude Opus 4.7 + Opus 4.7 Fast, Sonnet 4.6, GPT-4o, GPT-5.4/5.5",
      "Gemini 2.5/3.x Pro, Grok 4.20, Llama 3.3 70B",
      "Codex variants, Devstral, Qwen3 Coder",
      "Up to 3 models per comparison",
    ],
    cta: "Upgrade to Pro",
    highlight: true,
  },
  {
    ...
    description: "For deep research. Reasoning specialists + 5-model comparisons.",
    features: [
      "Everything in Pro, plus…",
      "GPT-5.4 Pro & GPT-5.5 Pro (deep-think reasoning)",
      "DeepSeek v4 Pro, Qwen3 Max Thinking",
      "Grok 4.20 Multi-Agent (experimental agentic)",
