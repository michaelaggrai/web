      ...
      <div className="relative z-10 mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert prose-sm sm:prose-base max-w-none mt-10
          ...
          <ul>
            ...
            <li><strong>Conversations &amp; personalisation</strong>: if you&apos;re signed in and
              ...
              also set an optional <em>personalisation</em> profile (how you like answers written —
              length, tone, background, interests). If you switch on &ldquo;Fill this in for
              me&rdquo; (<strong>off unless you turn it on</strong>), we additionally store
              short facts aggrai infers from the questions you have asked. All of this is
              per-account and can be reviewed, edited or cleared in{" "}
              <a href="/settings">Settings &rarr; Personalisation</a>.</li>
          ...
          <ul>
            ...
            <li>To tailor answers to you, by including the personalisation preferences and
              any learned facts you have chosen to store (Settings &rarr; Personalisation)
              in the prompt sent to the model. This applies to every question you ask while
              signed in, including the first one in a conversation. It is never applied to
              the cached example questions on the landing page (those answers are shared
              between all visitors), and it is never used to train models.</li>
          ...
          <ul>
            ...
            <li>Cached example responses are retained for up to 24 hours and refreshed
              periodically.</li>
            <li>Saved conversations and your personalisation profile are retained until you delete
              the conversation, clear your profile, or delete your account. Both are included
