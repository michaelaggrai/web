...
const BRAND_COLORS: Record<string, string> = {
  "anthropic/claude-sonnet-4-6": "#D97757",
  "openai/gpt-4o": "#10A37F",
  "google/gemini-2.5-flash": "#4285F4",
  "mistralai/mistral-small-3.2-24b-instruct": "#FF7000",
  "meta-llama/llama-3.1-8b-instruct": "#0467DF",
}

type IconProps = { className?: string; style?: React.CSSProperties }

function AnthropicIcon({ className, style }: IconProps) {
  return (
...
function GoogleIcon({ className, style }: IconProps) {
  return (
...
function MistralIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
function MetaIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const ICONS: Record<string, (p: IconProps) => React.JSX.Element> = {
  ...
  "openai/gpt-4o": OpenAIIcon,
  "google/gemini-2.5-flash": GoogleIcon,
  "mistralai/mistral-small-3.2-24b-instruct": MistralIcon,
  "meta-llama/llama-3.1-8b-instruct": MetaIcon,
}

export function ModelLoader({ modelId, size = 28 }: { modelId: string; size?: number }) {
  const Icon = ICONS[modelId] ?? AnthropicIcon
  const color = BRAND_COLORS[modelId] ?? "#A0A0A0"
  // Google logo is multicolor; don't override its fills via currentColor
  const isMulticolor = modelId === "google/gemini-2.5-flash"
  return (
