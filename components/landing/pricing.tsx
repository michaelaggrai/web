...
const tiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "15 flagship models: GPT-4o, Sonnet 4.6, Gemini Pro, Codex, Devstral…",
      "Creative, coding & multimodal categories",
      "Up to 3 models per comparison",
    ],
    highlighted: true,
    buttonText: "Get Pro",
  ...
  },
  {
    ...
    price: "£19",
    period: "per month",
    description: "Reasoning + frontier models. The most thorough comparisons.",
    Icon: Crown,
    iconColor: "text-amber-300",
    features: [
      "Everything in Pro, plus…",
      "Claude Opus 4.7, GPT-5.4/5.5 Pro, Grok 4.20",
